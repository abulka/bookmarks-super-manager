import {
  ...
  Folder, FolderClosed, FolderOpen, FolderPlus, Folders, Frown, Globe, Grid2x2, Home, Inbox, Info, Layers, Link2, List, ListTree, Loader2,
  Menu, Moon, MoreHorizontal, MousePointer2, Network, PanelLeft, Pencil, PencilSparkles, Plus, RefreshCw, RotateCcw,
